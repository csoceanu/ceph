...
.. warning:: 
   ...
   To use Podman with Ceph Pacific and later, you must use **a version of Podman that
   is 3.0.0 or higher** to ensure better security and rootless container support.
